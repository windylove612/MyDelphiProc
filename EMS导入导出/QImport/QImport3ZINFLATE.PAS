...
uses
  QImport3zutil, QImport3zlib110, QImport3infblock, QImport3infutil;

function inflateInit(var z : z_stream) : int_t;
...
function inflateEnd(var z : z_stream) : int_t;
...
function inflateReset(var z : z_stream) : int_t;
...
function inflateSync(var z : z_stream) : int_t;
...
function inflateSyncPoint(var z : z_stream) : int_t;
...
function inflateInit2(var z: z_stream; windowBits : int_t) : int_t;
begin
