...
type
  ...
  z_stream = record
    ...
    msg : ShortString;         { last error message, '' if no error }
    ...
    data_type : int_t;      { best guess about the data type: ascii or binary }
...
function zError(err : int_t) : AnsiString;
